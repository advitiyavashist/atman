...
NEED = [
    "DEFAULT_RUN_TIMEOUT_MIN", "HARNESS_PLACEHOLDERS", "LOCAL_DISPATCH_MAX_ATTEMPTS",
    "RUN_HEARTBEAT_SECS", "STOP_CONDITION", "WAKE_KEYS",
    "WATCH_LOG_MAX_BYTES", "WATCH_MIN_INTERVAL", "WATCH_STOP_SLICE",
    "_active_seat_limit", "_adapter_provider", "_agent_holds_ticket",
    "_agent_rec", "_agent_set", "_agent_update",
    "_auth_gates_spawn", "_classify_auth_output", "_cursor_hook_agent",
    "_drop_unowned_agent_ticket", "_expand_harness_cmd", "_expected_origin_for",
    "_finalize_active_watch_run", "_find_checkout_for_origin", "_format_live_watchers",
    "_git_main_worktree", "_git_remote_origin", "_git_root_from",
    "_harness_auth_spec", "_harness_check_label", "_harness_of_cmd",
    "_identity_reuse_conflict", "_identity_reuse_error", "_inherit_settings",
    "_init_cwd_worktree_root", "_iso_span_secs", "_join_namespace",
    "_keep_lead", "_live_watch_pids", "_local_adapter_failure",
    "_mark_run_interrupted", "_master_log", "_origin_key",
    "_pin_spawned_worker_hooks", "_preflight", "_preflight_seat",
    "_print_auth_result", "_re", "_read_run_slice",
    "_reclaim_unrelated_watch_pidfile", "_record_watch_stall", "_refresh_auth_check",
    "_refuse_limited_seat", "_release_commit", "_remote_epoch",
    "_remote_trigger_key", "_render_prompt_file", "_replace_seat_watchers",
    "_repo_spec_is_path", "_resolve_watch_stall", "_run_beat",
    "_run_begin", "_run_end", "_run_end_limit_outcome",
    "_run_had_bound_write", "_run_usage", "_safe",
    "_seat_live_watchers", "_session_adapters", "_shared_watch_table",
    "_silent", "_spawn_base_ref", "_spawn_verify_started_watcher",
    "_split_harness", "_stall_watch", "_stop_file",
    "_store_auth_check", "_strip_identity_bound_state", "_supervisor_launch_env",
    "_time", "_validated_owned_watch_pid", "_watch_bind_ticket",
    "_watch_lock", "_watch_note_limit_from_log", "_watch_poke_file",
    "_watch_poll_wait", "_watch_table_available", "_watch_trigger_fingerprint",
    "_watcher_run_active", "_worker_cmd", "actionable",
    "agents_dir", "checkin", "cmd_brief",
    "cmd_join", "current_master", "e",
    "fmt_hours", "harness_of", "hours_since",
    "lifecycle_of", "load_agents", "load_workforce",
    "master_state_path", "normalize_git_origin", "now",
    "pending_work", "post_message", "print_seat_usage",
    "repo_identity_matches", "resolve_launch_policy", "run_timeout_floor_warning",
    "save_workforce", "select", "signal",
    "spawn_repo_identity_ok", "spawn_watch_max_runs", "threading",
    "traj_event", "wake_mode_of", "wake_reason_of",
    "whoami",
]
