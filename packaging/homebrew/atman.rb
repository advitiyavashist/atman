class Atman < Formula
  ...
  url "https://github.com/advitiyavashist/atman/releases/download/v0.2.0/atman-0.2.0.tar.gz"
  sha256 "REPLACE_BEFORE_RELEASE_run_scripts/build_release_tarball.py"
  license "MIT"
