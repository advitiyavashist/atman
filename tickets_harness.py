...
NEED = [
    ...
    "_agent_rec", "_agent_set", "_auth_execution_context",
    "_auth_probe_env", "_classify_auth_output", "_cos_label",
    "_expand_harness_cmd", "_harness_auth_spec", "_harness_template_error",
    "_json_candidates", "_maybe_refresh_provider_usage", "_print_role_discovery",
    "_profile_kind_for", "_provider_usage", "_refresh_auth_check",
    "_render_prompt_file", "_safe", "_sounding",
    "_supervisor_launch_env", "_time", "_which_on_path",
    "_worker_cmd", "board_is_atman_operator", "board_is_living",
    "classify_catalog_usage", "detect_auth_error", "fmt_hours",
    "harness_of", "hours_since", "load_agents",
    "load_workforce", "now", "parse_cursor_admin",
    "parse_provider_quota", "print_integration_catalog", "print_recorded_usage",
    "reclaim_stale_watch_lock", "retarget_stale_local_codex", "whoami",
]
