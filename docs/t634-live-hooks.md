...
- Global command: `/Users/<operator>/.local/bin/tickets`
- Preserved 3a641 launcher: `/Users/<operator>/.claude/tools/tickets-releases/previous-86569dbf42fb11f81dcd5cb9e0825bb5df32b5bd16e446b714f1da5fe03aa160`
- Immediate prior launcher: `/Users/<operator>/.claude/tools/tickets-releases/previous-bb4b89676683b86899cf043f4d38026d74ad54620640c07df9f1bfd556df2ee8`
...
```sh
tickets hooks claude --agent sol-ceo-cto --settings /Users/<operator>/.claude/settings.json --rollback
tickets hooks codex --agent codex-master --hooks-file /Users/<operator>/.codex/hooks.json --rollback
tickets hooks cursor --agent cursor --worktree /Users/<operator> --rollback
tickets hooks remote --agent grok-worker --wrapper /Users/<operator>/.local/bin/tickets-grok-worker --rollback
```
...
|---|---|---|
| Claude Code | `sol-ceo-cto` | `/Users/<operator>/.claude/settings.json` |
| Codex | `codex-master` | `/Users/<operator>/.codex/hooks.json`, scoped to `/Users/<operator>/Downloads/steer/.worktrees/sol-ceo-cto` |
| Cursor | `cursor` | `/Users/<operator>/.cursor/hooks.json` and `/Users/<operator>/.cursor/hooks/tickets-board.py` |
| Grok/custom remote | `grok-worker` | `/Users/<operator>/.local/bin/tickets-grok-worker` and its `.hooks.json` manifest |
