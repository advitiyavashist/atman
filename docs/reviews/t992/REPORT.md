...
**App-only successor:** replay T-810/T-884/T-992 onto `origin/main` `457767b` without PR156 ancestry (no train-2 backend heads, no T-931/T-932/T-956, no knowledge/session_boundary). Browser shots below remain the accepted 8bd576 throwaway-board evidence for the same three rendered behaviors.
...
T-005 REVIEW stays `Submitted … Awaiting review of <sha> · no verdict recorded`, never Accepted (check 02). Light mode `--acc #6b5344` (check 04). Mutation pending/confirmed/failed, offline≠lost, reload resync and the same-second reopen boundary are untouched code paths (T-986 shots 10–17 at 033cb73 still apply; the focused suite covering them passed at this SHA).
