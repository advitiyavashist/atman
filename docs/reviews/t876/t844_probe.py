...
WHEEL = Path('/private/tmp/t876-independent-wheel/venv/bin/tickets')
scratch = Path(tempfile.mkdtemp(prefix='atman-t844-probes-', dir='/private/tmp'))
...
def run(entry, board, args, sid='fresh', agent=None, seat=None, cwd=None, stdin=None):
    ...
    if entry == 'baseline':
        cmd = [sys.executable, '/Users/kavana/Downloads/atman/.worktrees/atman-t844-baseline/tickets.py']
    else:
