...
| 2 | board | Two tickets, one real dependency: B is blocked until A is accepted. |
...
| 5 | unblock | B is unblocked, and A's accepted commit travels with it as the handoff. |
