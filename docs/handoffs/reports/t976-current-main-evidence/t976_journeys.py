...
ATM='/tmp/atman-t976-0922-bin/atm'
ENV={k:v for k,v in os.environ.items() if not k.startswith(('TICKET','ATMAN','CLAUDE','CODEX','CURSOR'))}
ENV.update(PATH='/tmp/atman-t976-0922-bin:/usr/bin:/bin:/usr/sbin:/sbin',PYTHONDONTWRITEBYTECODE='1',TICKETS_USAGE_REFRESH='0',PYTEST_CURRENT_TEST='t976_disposable_stub_journeys',GIT_CONFIG_NOSYSTEM='1',GIT_CONFIG_GLOBAL='/dev/null')
LOG=[]
