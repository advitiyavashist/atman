...
def cmd_done(a, board):
    ...
    # T-1082: accepted_sha wins over cwd HEAD when --artifact was omitted.
    # Coordinator `done` from main after accept used to overwrite the pin
    # with main@HEAD and hand that to the successor.
