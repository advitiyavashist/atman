...
EVIDENCE = "landing/assets/t732-dashboard-1440.png"
...
def test_embedded_dashboard_uses_bone_brass_not_steer_lime():
    ...
    assert 'id="boardName"' in ui
    assert "workspace · " in ui
    assert "boardName.textContent=show?proj" not in ui
...
def test_landing_assets_exist_for_the_deployed_directory():
