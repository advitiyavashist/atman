...
def _release_cmd(sha, agent, cwd="/repo"):
    return ("/opt/homebrew/bin/python3 "
            "$HOME/.claude/tools/tickets-releases/%s/tickets.py watch "
...
@pytest.mark.parametrize("cmd", [
    "/usr/bin/python3 $HOME/.claude/tools/tickets.py spawn cursor-modal --stop",
