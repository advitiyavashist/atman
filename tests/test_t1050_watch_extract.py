...
Proven red on cursor-onboard/t1050-harness-redo@f760eaf: tickets_watch.py does
not exist, so importing it fails. After the extract the facade aliases must
point at the sibling. Spawn must still exec the facade file, not the sibling.
"""
