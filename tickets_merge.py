...
NEED = [
    ...
    "_record_pin", "_recovery", "_refuse_unreleased_deps", "_reopen_unverified_successors",
    "_review_verdict", "_round3", "_safe", "_sounding", "_start_successors", "_traj_git",
    "_trunk", "_work_view", "_worktree_gc", "artifact_tree", "checkin", "current_master",
    "fmt_hours", "git", "git_state", "load", "load_all", "now", "post_message",
    "repo_identity", "save", "timing", "traj_event", "whoami",
]
